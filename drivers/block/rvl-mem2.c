 ...
 */
static void mem2_release(struct gendisk *disk, fmode_t mode)
{
 ...
 */
static int __exit mem2_of_remove(struct platform_device *odev)
{
...
static int __init mem2_init_module(void)
{
	...
	return platform_driver_register(&mem2_of_driver);
}
...
{
	platform_driver_unregister(&mem2_of_driver);
}
